# Medium Swing OPEN Drop-Family Phrase-Scope Method Continuity Audit

- Contract version: `v2_10_8`
- Milestone: `v2_6_48 — Medium Swing OPEN Drop-Family Phrase-Scope Method Continuity Plan`
- Acceptance passed: `True`

## All the Things You Are

- MIDI: `demos/v2_6_48_all_the_things_you_are_medium_swing_phrase_scope_method_continuity_demo.mid`
- Events: `174`
- Families: `{'open': 174}`
...
- Phrase-scope events / switches / ratio: `84` / `34` / `0.4048`
- Phrase-scope DROP2&4 run events / max: `1` / `1`
- Phrase-scope ii-V / V-I / ii-V-I events: `30` / `27` / `27`
- Phrase-scope ii-V-I method consistent / switch: `10` / `17`
- Phrase-scope high-motion switches / warnings / checkpoint: `0` / `0` / `True`

## Autumn Leaves

- MIDI: `demos/v2_6_48_autumn_leaves_medium_swing_phrase_scope_method_continuity_demo.mid`
- Events: `223`
- Families: `{'open': 223}`
...
- Phrase-scope events / switches / ratio: `117` / `50` / `0.4274`
- Phrase-scope DROP2&4 run events / max: `24` / `2`
- Phrase-scope ii-V / V-I / ii-V-I events: `45` / `21` / `21`
- Phrase-scope ii-V-I method consistent / switch: `8` / `13`
- Phrase-scope high-motion switches / warnings / checkpoint: `0` / `0` / `True`
...
- `all_the_things_you_are: phrase-scope method continuity checkpoint passes`: `True` — `{'phrase_scope_events': 84, 'method_switch_ratio': 0.4048, 'drop2_and_4_run_max': 1, 'high_motion_switch_events': 0, 'warnings': 0, 'legacy_output_without_v2_6_48_fields': False}`
- `all_the_things_you_are: DROP2&4 stays phrase-internal color`: `True` — `{'drop2_and_4_run_events': 1, 'drop2_and_4_run_max': 1}`
...
- `autumn_leaves: phrase-scope method continuity checkpoint passes`: `True` — `{'phrase_scope_events': 117, 'method_switch_ratio': 0.4274, 'drop2_and_4_run_max': 2, 'high_motion_switch_events': 0, 'warnings': 0, 'legacy_output_without_v2_6_48_fields': False}`
- `autumn_leaves: DROP2&4 stays phrase-internal color`: `True` — `{'drop2_and_4_run_events': 24, 'drop2_and_4_run_max': 2}`
