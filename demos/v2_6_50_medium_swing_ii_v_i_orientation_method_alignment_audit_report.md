...
- Milestone: `v2_6_50 — Medium Swing OPEN Drop-Family ii–V–I Orientation / Method Alignment`
- Acceptance passed: `True`

## All the Things You Are

- MIDI: `demos/v2_6_50_all_the_things_you_are_medium_swing_ii_v_i_orientation_method_alignment_demo.mid`
- Events: `174`
- Families: `{'open': 174}`
...
- MIDI: `demos/v2_6_50_autumn_leaves_medium_swing_ii_v_i_orientation_method_alignment_demo.mid`
- Events: `223`
- Families: `{'open': 223}`
...
- Phrase-scope high-motion switches / warnings / checkpoint: `0` / `0` / `True`
- Method-lock applied / matched / mismatched / checkpoint: `100` / `100` / `0` / `True`
- Rootless A/B orientation runtime-enabled / applied / filtered / checkpoint: `100` / `0` / `0` / `True`
- Rootless A/B orientation desired / selected / skip reasons: `{}` / `{}` / `{'previous_seed_not_rootless_ab': 100}`
