...
def context_profile_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "user_practice_profile_context_intake_spec_route": "GET /agent/context/user-practice-profile/spec",
        "practice_context_storage_boundary_spec_route": "GET /agent/context/storage-boundary/spec",
        "today_practice_guidance_profile_aware_e2e_spec_route": "GET /agent/context/today-practice-guidance/profile-aware/spec",
        "practice_plan_persistence_candidate_spec_route": "GET /agent/practice-plan/persistence-candidate/spec",
        "routine_history_persistence_candidate_spec_route": "GET /agent/routine-history/persistence-candidate/spec",
        "context_persistence_confirmation_boundary_spec_route": "GET /agent/context/persistence-confirmation/spec",
        "context_persistence_executor_noop_spec_route": "GET /agent/context/persistence-executor-noop/spec",
        "context_persistence_storage_adapter_design_spec_route": "GET /agent/context/persistence-storage-adapter/spec",
        "context_persistence_sqlite_dev_preview_spec_route": "GET /agent/context/persistence-sqlite-dev-preview/spec",
        "context_persistence_dev_sqlite_write_gate_spec_route": "GET /agent/context/persistence-dev-sqlite-write-gate/spec",
        "context_persistence_dev_sqlite_fixture_write_dry_run_spec_route": "GET /agent/context/persistence-dev-sqlite-fixture-write-dry-run/spec",
        "context_persistence_dev_sqlite_fixture_store_spec_route": "GET /agent/context/persistence-dev-sqlite-fixture-store/spec",
        "context_persistence_dev_fixture_readback_replay_spec_route": "GET /agent/context/persistence-dev-fixture-readback-replay/spec",
        "context_persistence_profile_plan_history_snapshot_context_intake_spec_route": "GET /agent/context/persistence-snapshot-context-intake/spec",
        "today_practice_guidance_persisted_context_recovery_e2e_spec_route": "GET /agent/context/today-practice-guidance/persisted-context-recovery/spec",
        "today_practice_guidance_persisted_context_terminal_memory_controls_terminal_commands": ["/persisted-context-load", "/persisted-context-show", "/persisted-context-clear"],
        "today_practice_guidance_terminal_memory_to_harmonyos_debug_fixture_spec_route": "GET /agent/context/today-practice-guidance/terminal-memory-harmonyos-debug-fixture/spec",
        "today_practice_guidance_harmonyos_debug_fixture_roundtrip_terminal_e2e_spec_route": "GET /agent/context/today-practice-guidance/harmonyos-debug-fixture-roundtrip/spec",
        "today_practice_guidance_harmonyos_debug_fixture_api_request_pack_spec_route": "GET /agent/context/today-practice-guidance/harmonyos-debug-fixture-api-request-pack/spec",
        "today_practice_guidance_terminal_product_smoke_polish_spec_route": "GET /agent/context/today-practice-guidance/terminal-product-smoke/spec",
        "agent_v2_8_phase_cleanup_regression_handoff_spec_route": "GET /agent/context/today-practice-guidance/v2-8-phase-handoff/spec",
        "context_persistence_sqlite_backend_store_spec_route": "GET /agent/context/persistence-sqlite-backend-store/spec",
        "context_persistence_sqlite_backend_readback_context_recovery_spec_route": "GET /agent/context/persistence-sqlite-backend-readback-context-recovery/spec",
        "context_persistence_sqlite_backend_today_guidance_recovery_e2e_spec_route": "GET /agent/context/persistence-sqlite-backend-today-guidance-recovery-e2e/spec",
        "context_persistence_sqlite_backend_terminal_memory_autoload_preview_spec_route": "GET /agent/context/persistence-sqlite-backend-terminal-memory-autoload-preview/spec",
        "context_persistence_sqlite_backend_terminal_memory_to_guidance_smoke_spec_route": "GET /agent/context/persistence-sqlite-backend-terminal-memory-to-guidance-smoke/spec",
        "context_persistence_sqlite_backend_api_memory_debug_pack_spec_route": "GET /agent/context/persistence-sqlite-backend-api-memory-debug-pack/spec",
        "context_persistence_sqlite_backend_harmonyos_api_fixture_pack_spec_route": "GET /agent/context/persistence-sqlite-backend-harmonyos-api-fixture-pack/spec",
        "context_persistence_sqlite_backend_api_error_shape_matrix_spec_route": "GET /agent/context/persistence-sqlite-backend-api-error-shape-matrix/spec",
        "context_persistence_sqlite_backend_harmonyos_error_fixture_pack_spec_route": "GET /agent/context/persistence-sqlite-backend-harmonyos-error-fixture-pack/spec",
        "context_persistence_sqlite_backend_handoff_completion_pack_spec_route": "GET /agent/context/persistence-sqlite-backend-handoff-completion-pack/spec",
        "context_persistence_backend_db_path_policy_and_migration_guard_spec_route": "GET /agent/context/persistence-backend-db-path-policy-migration-guard/spec",
        "context_persistence_backend_schema_metadata_table_preview_spec_route": "GET /agent/context/persistence-backend-schema-metadata-table-preview/spec",
        "agent_usable_today_practice_guidance_mvp_spec_route": "GET /agent/context/usable-today-practice-guidance-mvp/spec",
        "agent_routine_completion_record_to_backend_context_write_mvp_spec_route": "GET /agent/context/routine-completion-record-to-backend-context-write-mvp/spec",
        "agent_routine_completion_to_today_guidance_product_smoke_spec_route": "GET /agent/context/routine-completion-to-today-guidance-product-smoke/spec",
        "agent_harmonyos_today_guidance_api_contract_alignment_spec_route": "GET /agent/harmonyos/today-guidance-api-contract-alignment/spec",
        "agent_harmonyos_today_practice_guidance_preview_route": "POST /agent/harmonyos/today-practice-guidance/preview",
        "agent_harmonyos_routine_completion_record_execute_route": "POST /agent/harmonyos/routine-completion-record/execute",
...
def llm_context_runtime_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "routes": {
            ...
            "user_practice_profile_context_intake_spec": "GET /agent/context/user-practice-profile/spec",
            "user_practice_profile_context_intake": "POST /agent/context/user-practice-profile/intake",
            "practice_context_storage_boundary_spec": "GET /agent/context/storage-boundary/spec",
            "practice_context_storage_boundary_preview": "POST /agent/context/storage-boundary/preview",
            "today_practice_guidance_profile_aware_e2e_spec": "GET /agent/context/today-practice-guidance/profile-aware/spec",
            "today_practice_guidance_profile_aware_e2e_preview": "POST /agent/context/today-practice-guidance/profile-aware/e2e-preview",
            "practice_plan_persistence_candidate_spec": "GET /agent/practice-plan/persistence-candidate/spec",
            "practice_plan_persistence_candidate_preview": "POST /agent/practice-plan/persistence-candidate/preview",
            "routine_history_persistence_candidate_spec": "GET /agent/routine-history/persistence-candidate/spec",
            "routine_history_persistence_candidate_preview": "POST /agent/routine-history/persistence-candidate/preview",
            "context_persistence_confirmation_boundary_spec": "GET /agent/context/persistence-confirmation/spec",
            "context_persistence_confirmation_boundary_preview": "POST /agent/context/persistence-confirmation/preview",
            "context_persistence_executor_noop_spec": "GET /agent/context/persistence-executor-noop/spec",
            "context_persistence_executor_noop_preview": "POST /agent/context/persistence-executor-noop/preview",
            "context_persistence_storage_adapter_design_spec": "GET /agent/context/persistence-storage-adapter/spec",
            "context_persistence_storage_adapter_design_preview": "POST /agent/context/persistence-storage-adapter/design-preview",
            "context_persistence_sqlite_dev_preview_spec": "GET /agent/context/persistence-sqlite-dev-preview/spec",
            "context_persistence_sqlite_dev_preview": "POST /agent/context/persistence-sqlite-dev-preview/preview",
            "context_persistence_dev_sqlite_write_gate_spec": "GET /agent/context/persistence-dev-sqlite-write-gate/spec",
            "context_persistence_dev_sqlite_write_gate": "POST /agent/context/persistence-dev-sqlite-write-gate/preview",
            "context_persistence_dev_sqlite_fixture_write_dry_run_spec": "GET /agent/context/persistence-dev-sqlite-fixture-write-dry-run/spec",
            "context_persistence_dev_sqlite_fixture_write_dry_run": "POST /agent/context/persistence-dev-sqlite-fixture-write-dry-run/preview",
            "context_persistence_dev_sqlite_fixture_store_spec": "GET /agent/context/persistence-dev-sqlite-fixture-store/spec",
            "context_persistence_dev_sqlite_fixture_store": "POST /agent/context/persistence-dev-sqlite-fixture-store/preview",
            "context_persistence_dev_fixture_readback_replay_spec": "GET /agent/context/persistence-dev-fixture-readback-replay/spec",
            "context_persistence_dev_fixture_readback_replay": "POST /agent/context/persistence-dev-fixture-readback-replay/preview",
            "context_persistence_profile_plan_history_snapshot_context_intake_spec": "GET /agent/context/persistence-snapshot-context-intake/spec",
            "context_persistence_profile_plan_history_snapshot_context_intake": "POST /agent/context/persistence-snapshot-context-intake/preview",
            "today_practice_guidance_persisted_context_recovery_e2e_preview": "POST /agent/context/today-practice-guidance/persisted-context-recovery/e2e-preview",
            "today_practice_guidance_persisted_context_terminal_memory_controls": "terminal-only: /persisted-context-load | /persisted-context-show | /persisted-context-clear",
            "today_practice_guidance_terminal_memory_to_harmonyos_debug_fixture": "POST /agent/context/today-practice-guidance/terminal-memory-harmonyos-debug-fixture/preview",
            "today_practice_guidance_harmonyos_debug_fixture_roundtrip_terminal_e2e": "POST /agent/context/today-practice-guidance/harmonyos-debug-fixture-roundtrip/e2e-preview",
            "today_practice_guidance_harmonyos_debug_fixture_api_request_pack": "POST /agent/context/today-practice-guidance/harmonyos-debug-fixture-api-request-pack/preview",
            "today_practice_guidance_terminal_product_smoke_polish": "POST /agent/context/today-practice-guidance/terminal-product-smoke/preview",
            "agent_v2_8_phase_cleanup_regression_handoff": "POST /agent/context/today-practice-guidance/v2-8-phase-handoff/preview",
            "context_persistence_sqlite_backend_store": "POST /agent/context/persistence-sqlite-backend-store/execute",
            "context_persistence_sqlite_backend_readback_context_recovery": "POST /agent/context/persistence-sqlite-backend-readback-context-recovery/preview",
            "context_persistence_sqlite_backend_today_guidance_recovery_e2e": "POST /agent/context/persistence-sqlite-backend-today-guidance-recovery-e2e/preview",
            "context_persistence_sqlite_backend_terminal_memory_autoload_preview": "POST /agent/context/persistence-sqlite-backend-terminal-memory-autoload-preview/preview",
            "context_persistence_sqlite_backend_terminal_memory_to_guidance_smoke": "POST /agent/context/persistence-sqlite-backend-terminal-memory-to-guidance-smoke/preview",
            "context_persistence_sqlite_backend_api_memory_debug_pack": "POST /agent/context/persistence-sqlite-backend-api-memory-debug-pack/preview",
            "context_persistence_sqlite_backend_harmonyos_api_fixture_pack": "POST /agent/context/persistence-sqlite-backend-harmonyos-api-fixture-pack/preview",
            "context_persistence_sqlite_backend_api_error_shape_matrix": "POST /agent/context/persistence-sqlite-backend-api-error-shape-matrix/preview",
            "context_persistence_sqlite_backend_harmonyos_error_fixture_pack": "POST /agent/context/persistence-sqlite-backend-harmonyos-error-fixture-pack/preview",
            "context_persistence_sqlite_backend_handoff_completion_pack": "POST /agent/context/persistence-sqlite-backend-handoff-completion-pack/preview",
            "context_persistence_backend_db_path_policy_and_migration_guard": "POST /agent/context/persistence-backend-db-path-policy-migration-guard/preview",
            "context_persistence_backend_schema_metadata_table_preview": "POST /agent/context/persistence-backend-schema-metadata-table-preview/preview",
            "agent_usable_today_practice_guidance_mvp": "POST /agent/context/usable-today-practice-guidance-mvp/preview",
            "agent_routine_completion_record_to_backend_context_write_mvp": "POST /agent/context/routine-completion-record-to-backend-context-write-mvp/execute",
            "agent_routine_completion_to_today_guidance_product_smoke": "POST /agent/context/routine-completion-to-today-guidance-product-smoke/execute",
            "agent_harmonyos_today_guidance_api_contract_alignment": "POST /agent/harmonyos/today-guidance-api-contract-alignment/preview",
            "agent_harmonyos_today_practice_guidance_preview": "POST /agent/harmonyos/today-practice-guidance/preview",
            "agent_harmonyos_routine_completion_record_execute": "POST /agent/harmonyos/routine-completion-record/execute",
        ...
        "context_packet_layers": {
            ...
            "user_practice_profile_context": "Durable user goals/preferences/comfort ranges supplied through v2_8_1 profile intake.",
            "practice_context_storage_boundary": "v2_8_2 ownership map for local/backend/request/trace context; contract only, no storage write.",
            "today_practice_guidance_profile_aware_e2e": "v2_8_3 profile-aware today-practice guidance uses UserPracticeProfileContext as soft personalization context.",
            "practice_plan_persistence_candidate": "v2_8_6 save/update PracticePlan candidate contract; preview + confirmation boundary only, no storage write.",
            "routine_history_persistence_candidate": "v2_8_7 save/upload RoutineHistory summary candidate contract; preview + confirmation boundary only, no storage write.",
            "context_persistence_confirmation_boundary": "v2_8_8 unified confirmation record boundary for PracticePlan/RoutineHistory persistence candidates; no storage write.",
            "context_persistence_executor_noop": "v2_8_9 future persistence executor skeleton; no-op execution report only, no storage write.",
            "context_persistence_storage_adapter_design": "v2_8_10 future real storage adapter interface and boundary design; design-only, no storage write.",
            "context_persistence_sqlite_dev_preview": "v2_8_11 dev-only SQLite/fixture schema, idempotency, trace-link, and snapshot preview; no database connection or write.",
            "context_persistence_dev_sqlite_write_gate": "v2_8_12 explicit dev-only SQLite write gate/config-path contract; no database connection or write.",
            "context_persistence_dev_sqlite_fixture_write_dry_run": "v2_8_13 dev SQLite fixture writer dry-run; simulates transaction/idempotency/trace/read-back without durable write.",
            "context_persistence_dev_sqlite_fixture_store": "v2_8_14 dev-only explicit opt-in fixture JSONL store; no SQLite/backend database write.",
            "context_persistence_dev_fixture_readback_replay": "v2_8_15 dev fixture JSONL read-back and replay preview; read-only, no mutation.",
            "context_persistence_profile_plan_history_snapshot_context_intake": "v2_8_16 snapshot-to-context intake for user profile, active plan, and routine history sections.",
            "today_practice_guidance_persisted_context_recovery_e2e": "v2_8_17 recovered persisted snapshot context feeds profile-aware today-practice guidance; display-only, no Routine start.",
            "today_practice_guidance_persisted_context_terminal_memory_controls": "v2_8_18 terminal-only load/show/clear session memory for recovered profile/plan/history context.",
            "today_practice_guidance_terminal_memory_to_harmonyos_debug_fixture": "v2_8_19 serializes terminal memory into a HarmonyOS debug fixture preview without frontend flow assumptions.",
            "today_practice_guidance_harmonyos_debug_fixture_roundtrip_terminal_e2e": "v2_8_20 roundtrips HarmonyOS debug fixture request payload back into persisted-context guidance preview.",
            "today_practice_guidance_harmonyos_debug_fixture_api_request_pack": "v2_8_21 packages HarmonyOS debug fixture endpoints, request bodies, response paths, curl examples, and terminal equivalents for frontend联调.",
            "today_practice_guidance_terminal_product_smoke_polish": "v2_8_22 packages terminal setup/doctor, ordinary Chinese guidance, persisted memory, JSON fallback, and guarded-error smoke checks.",
            "agent_v2_8_phase_cleanup_regression_handoff": "v2_8_23 closes Agent v2_8 with regression checklist, terminal/HarmonyOS handoff, persistence boundary, and next-phase guidance.",
            "context_persistence_sqlite_backend_store": "v2_9_0 explicit backend SQLite context persistence store; real DB write only after opt-in gates, redaction, idempotency, and trace-link checks.",
            "context_persistence_sqlite_backend_readback_context_recovery": "v2_9_1 read-only SQLite backend context recovery; reads persisted records and builds a ContextBuilder-ready recovery packet without writes or side effects.",
            "context_persistence_sqlite_backend_today_guidance_recovery_e2e": "v2_9_2 composes SQLite backend readback with today-practice guidance persisted-context recovery; display-only, no Routine/Engine/playback side effects.",
            "context_persistence_sqlite_backend_terminal_memory_autoload_preview": "v2_9_3 reads SQLite backend context into terminal session memory preview so the next ordinary today-practice turn can reuse it; CLI session-memory only.",
            "context_persistence_sqlite_backend_terminal_memory_to_guidance_smoke": "v2_9_4 compact smoke chain: explicit SQLite store, terminal memory autoload, then display-only today-practice guidance preview.",
            "context_persistence_sqlite_backend_api_memory_debug_pack": "v2_9_5 API debug pack; route catalog, request examples, response paths, and frontend-safe memory notes without SQLite connection or state mutation.",
            "context_persistence_sqlite_backend_harmonyos_api_fixture_pack": "v2_9_6 HarmonyOS API fixture pack; copyable request bodies, response assertions, and ArkTS fetch sketch for SQLite backend route联调 without frontend fixture file writes.",
            "context_persistence_sqlite_backend_api_error_shape_matrix": "v2_9_7 API error/blocked shape matrix for SQLite backend persistence/readback surfaces; preview-only, no SQLite connection or state mutation.",
            "context_persistence_sqlite_backend_harmonyos_error_fixture_pack": "v2_9_8 HarmonyOS error fixture pack; copyable bad-request examples, UI/debug messages, retry policies, and field assertions without route execution or frontend fixture writes.",
            "context_persistence_sqlite_backend_handoff_completion_pack": "v2_9_9 Agent-track handoff completion pack for SQLite backend persistence; summarizes routes, terminal commands, HarmonyOS fixtures, error shapes, integration checklist, and regression commands without SQLite connection or state mutation.",
            "context_persistence_backend_db_path_policy_and_migration_guard": "v2_10_0 backend DB path policy and migration guard; preview-only validation of SQLite path, schema version, migration mode, and observability requirements without opening SQLite.",
            "context_persistence_backend_schema_metadata_table_preview": "v2_10_1 schema metadata / migration registry table preview; defines future metadata tables without opening SQLite or executing migrations.",
            "agent_usable_today_practice_guidance_mvp": "v2_10_2 user-facing MVP: ordinary 今天该练什么 entry auto-reads configured SQLite context and returns display-only guidance or a clear no-context setup message.",
            "agent_routine_completion_record_to_backend_context_write_mvp": "v2_10_3 product-facing MVP: client-submitted routine completion record writes routine history into backend SQLite context for future guidance.",
            "agent_routine_completion_to_today_guidance_product_smoke": "v2_10_4 product smoke: confirmed completion write then ordinary today-practice guidance reads the real backend history.",
            "agent_harmonyos_today_guidance_api_contract_alignment": "v2_10_5 HarmonyOS-facing wrapper contract for completion-record write and today-practice guidance preview.",
        ...
        "user_practice_profile_context_intake_boundary": user_practice_profile_context_intake_contract(),
        "practice_context_storage_boundary": practice_context_storage_boundary_contract(),
        ...
        "today_practice_guidance_profile_aware_e2e_boundary": today_practice_guidance_profile_aware_e2e_contract(),
        "practice_plan_persistence_candidate_boundary": practice_plan_persistence_candidate_contract(),
        "routine_history_persistence_candidate_boundary": routine_history_persistence_candidate_contract(),
        "context_persistence_confirmation_boundary": context_persistence_confirmation_boundary_contract(),
        "context_persistence_executor_noop": context_persistence_executor_noop_contract(),
        "context_persistence_storage_adapter_design": context_persistence_storage_adapter_design_contract(),
        "context_persistence_sqlite_dev_preview": context_persistence_sqlite_dev_preview_contract(),
        "context_persistence_dev_sqlite_write_gate": context_persistence_dev_sqlite_write_gate_contract(),
        "context_persistence_dev_sqlite_fixture_write_dry_run": context_persistence_dev_sqlite_fixture_write_dry_run_contract(),
        "context_persistence_dev_sqlite_fixture_store": context_persistence_dev_sqlite_fixture_store_contract(),
        "context_persistence_dev_fixture_readback_replay": context_persistence_dev_fixture_readback_replay_contract(),
        "context_persistence_profile_plan_history_snapshot_context_intake": context_persistence_profile_plan_history_snapshot_context_intake_contract(),
        "today_practice_guidance_persisted_context_recovery_e2e": today_practice_guidance_persisted_context_recovery_e2e_contract(),
        "today_practice_guidance_persisted_context_terminal_memory_controls": today_practice_guidance_persisted_context_terminal_memory_controls_contract(),
        "today_practice_guidance_terminal_memory_to_harmonyos_debug_fixture": today_practice_guidance_terminal_memory_to_harmonyos_debug_fixture_contract(),
        "today_practice_guidance_harmonyos_debug_fixture_roundtrip_terminal_e2e": today_practice_guidance_harmonyos_debug_fixture_roundtrip_terminal_e2e_contract(),
        "today_practice_guidance_harmonyos_debug_fixture_api_request_pack": today_practice_guidance_harmonyos_debug_fixture_api_request_pack_contract(),
        "today_practice_guidance_terminal_product_smoke_polish": today_practice_guidance_terminal_product_smoke_polish_contract(),
        "agent_v2_8_phase_cleanup_regression_handoff": agent_v2_8_phase_cleanup_regression_handoff_contract(),
        "context_persistence_sqlite_backend_store": context_persistence_sqlite_backend_store_contract(),
        "context_persistence_sqlite_backend_readback_context_recovery": context_persistence_sqlite_backend_readback_context_recovery_contract(),
        "context_persistence_sqlite_backend_today_guidance_recovery_e2e": context_persistence_sqlite_backend_today_guidance_recovery_e2e_contract(),
        "context_persistence_sqlite_backend_terminal_memory_autoload_preview": context_persistence_sqlite_backend_terminal_memory_autoload_preview_contract(),
        "context_persistence_sqlite_backend_terminal_memory_to_guidance_smoke": context_persistence_sqlite_backend_terminal_memory_to_guidance_smoke_contract(),
        "context_persistence_sqlite_backend_api_memory_debug_pack": context_persistence_sqlite_backend_api_memory_debug_pack_contract(),
        "context_persistence_sqlite_backend_harmonyos_api_fixture_pack": context_persistence_sqlite_backend_harmonyos_api_fixture_pack_contract(),
        "context_persistence_sqlite_backend_api_error_shape_matrix": context_persistence_sqlite_backend_api_error_shape_matrix_contract(),
        "context_persistence_sqlite_backend_harmonyos_error_fixture_pack": context_persistence_sqlite_backend_harmonyos_error_fixture_pack_contract(),
        "context_persistence_sqlite_backend_handoff_completion_pack": context_persistence_sqlite_backend_handoff_completion_pack_contract(),
        "context_persistence_backend_db_path_policy_and_migration_guard": context_persistence_backend_db_path_policy_and_migration_guard_contract(),
        "context_persistence_backend_schema_metadata_table_preview": context_persistence_backend_schema_metadata_table_preview_contract(),
        "agent_usable_today_practice_guidance_mvp": agent_usable_today_practice_guidance_mvp_contract(),
        "agent_routine_completion_record_to_backend_context_write_mvp": agent_routine_completion_record_to_backend_context_write_mvp_contract(),
        "agent_routine_completion_to_today_guidance_product_smoke": agent_routine_completion_to_today_guidance_product_smoke_contract(),
        "agent_harmonyos_today_guidance_api_contract_alignment": agent_harmonyos_today_guidance_api_contract_alignment_contract(),
