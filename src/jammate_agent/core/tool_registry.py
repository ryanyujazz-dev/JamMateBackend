...
class AgentToolDescriptor:
    ...
    This registry is intentionally descriptive in v2_4_11. It does not execute
...
def tool_registry_manifest() -> dict[str, Any]:
    return {
        ...
        "rules": [
            ...
            "v2_4_11 does not execute tools from the runloop; deterministic API workflows remain the only execution path.",
