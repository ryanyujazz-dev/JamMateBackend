...
def trace_api_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "playback_prepare_guarded_design_trace_contract": {
            "version": "v2_6_9",
            "summary_field": "final_response_summary.playback_prepare_guarded_design_summary",
            "step_names": [
                "terminal_playback_prepare_guarded_payload_built",
                "terminal_playback_prepare_guarded_summary_recorded",
                "api_playback_prepare_guarded_payload_built",
            ],
            "chain": "agent_playback_prepare descriptor state -> guarded Routine setup candidate payload",
            "guarded_payload_enabled": True,
            "open_routine_setup_enabled": True,
        ...
        "routine_config_prepare_trace_contract": {
            "version": "v2_7_0",
            "summary_field": "final_response_summary.routine_config_prepare_summary",
            "step_names": [
                "terminal_routine_config_prepare_payload_built",
                "terminal_routine_config_prepare_summary_recorded",
                "api_routine_config_prepare_payload_built",
            ],
            "chain": "agent_routine_config_prepare descriptor state -> editable RoutineConfig draft payload",
        ...
        "practice_plan_to_routine_candidate_bridge_trace_contract": {
            "version": "v2_7_1",
            "summary_field": "final_response_summary.practice_plan_to_routine_candidate_bridge_summary",
            "step_names": [
            ...
            "chain": "practice-plan block -> UI-flow-agnostic Routine candidate payload",
