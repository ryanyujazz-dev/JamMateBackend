...
AGENT_TYPES_ETS = r'''
// JamMate Agent API Types v2_4_1
        ...
        "fixtures": {
            ...
            "agentContextRuntimePreviewResponse": {
                ...
                "runloop_preview": {
                    ...
                    "reason": "LLM provider is not configured in v2_4_1; use existing deterministic workflow.",
                    "warnings": [],
                },
