...
def score_candidate(candidate: VoicingCandidate, policy: VoicingPolicy, state: VoicingState | None = None) -> VoicingScoreBreakdown:
    ...
    return VoicingScoreBreakdown(
        ...
        details={
            ...
            "five_note_source_balance_score": round(source_balance_score, 4) if int(candidate.density or 0) == 5 else 0.0,
            "five_note_source_balance_key": source_balance_key(candidate) if int(candidate.density or 0) == 5 else "",
            "five_note_source_balance_gate_mode": source_gate_mode(candidate) if int(candidate.density or 0) == 5 else "",
