...
MILESTONE_ID = "v2_6_84"
MILESTONE_LABEL = "v2_6_84 — Medium Swing Repeat-Count-Aware Arrangement Arc Checkpoint"

REPEAT_POLICY_CASES = (1, 2, 3, 5, 6, 8, 9, 10, 50)
RUNTIME_SPECS: tuple[dict[str, Any], ...] = (
    {"slug": "all_the_things_you_are", "leadsheet": "all_the_things_you_are.json", "choruses": 3, "seed": 3840},
    {"slug": "autumn_leaves", "leadsheet": "autumn_leaves.json", "choruses": 3, "seed": 3841},
    {"slug": "all_the_things_you_are", "leadsheet": "all_the_things_you_are.json", "choruses": 5, "seed": 3842},
    {"slug": "autumn_leaves", "leadsheet": "autumn_leaves.json", "choruses": 5, "seed": 3843},
)
...
def main() -> None:
    ...
    summary = {
        ...
        "scope": (
            ...
            "long practice loops such as 50x. Runtime MIDI demos cover 3x and 5x full-band samples only; 50x is "
            "validated by policy simulation to avoid generating very long MIDI during checkpoint work. No new patterns, "
        ...
        "recommended_next_task": "v2_6_85_engine_medium_swing_arrangement_arc_runtime_intent_usage_if_checkpoint_passes",
    }
    summary_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_repeat_count_arrangement_arc_checkpoint_summary.json"
    report_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_repeat_count_arrangement_arc_checkpoint_report.md"
    ...
    return {
        ...
        "metadata": {
            "medium_swing_existing_voicing_capability_usage_policy": {
                ...
                "available": True,
                "enabled": True,
                "activation": "explicit_v2_6_84_repeat_count_arrangement_arc_checkpoint_demo",
                ...
                "repeat_count_aware_arrangement_arc_checkpoint_version": MILESTONE_ID,
                "repeat_count_aware_arrangement_arc_checkpoint_scope": "checkpoint_only_no_behavior_change",
...
def _generate_and_audit(spec: Mapping[str, Any]) -> dict[str, Any]:
    ...
    midi_path = DEMOS_DIR / f"{MILESTONE_ID}_{slug}_{choruses}x_medium_swing_repeat_count_arrangement_arc_checkpoint_demo.mid"
...
def _aggregate(outputs: list[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    for out in outputs:
        ...
        bucket = by_choruses.setdefault(key, {"demo_count": 0, "piano_active_pattern_events": 0, "active_anticipation_count": 0, "five_six_events": 0})
        bucket["demo_count"] += 1
...
def _acceptance(static: Mapping[str, Any], outputs: list[Mapping[str, Any]], aggregate: Mapping[str, Any]) -> dict[str, Any]:
    checks = [
        {"name": "v2_6_84 repeat-count arc declared", "passed": static.get("repeat_count_aware_arrangement_arc_version") == MILESTONE_ID and bool(static.get("repeat_count_aware_arrangement_arc_enabled"))},
