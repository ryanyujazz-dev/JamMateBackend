...
UNEXPANDED_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_3plus3_root_anchor_e2_e3_gap_p5_unexpanded_demo.mid"
UNEXPANDED_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_3plus3_root_anchor_e2_e3_gap_p5_unexpanded_audit_summary.json"
EXPANDED_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_3plus3_root_anchor_e2_e3_gap_p5_expanded_60pct_demo.mid"
EXPANDED_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_3plus3_root_anchor_e2_e3_gap_p5_expanded_60pct_audit_summary.json"


_CONTRACT_ID = "spread_3plus3_contract"
_VERSION = "v2_2_73"
...
def _listening_voicing_override(*, expanded: bool) -> dict[str, Any]:
    metadata: dict[str, Any] = {
        ...
        "ballad_spread_3plus3_pilot": {
            "version": _VERSION,
            "enabled": True,
            "required_recipe_id": _CONTRACT_ID,
            "dual_demo_required": True,
            "expanded_demo_target_ratio": 0.60,
            "target": "explicit_ballad_spread_3plus3_listening_isolation_only",
...
def _spread_3plus3_audit(debug: dict[str, Any], *, expanded_demo: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "scope": "Ballad SPREAD 3+3 dual-demo audit; rooted 3-note lower foundation includes root+3+7, removes root+5+7, caps lower span at 16 semitones, and rejects upper/lower note overlaps before groupwise voice-leading; expanded demo targets ~60% actual color.",
        ...
        "rooted_bass_anchor_policy": {
            ...
            "whole_register_high": "B5",
            "whole_register_low_midi": 40,
            "whole_register_high_midi": 83,
            ...
            "root37_included_in_lower_3note": True,
            "root57_removed_from_lower_3note": True,
            "lower_3note_max_span_semitones": 16,
            "lower_3note_highest_extension": "root_plus_major_tenth",
        },
        ...
        "upper_lower_overlap_events": upper_lower_overlap_events,
        "upper_3note_policy": {
            "placement": "closed_upper_stack",
            "drop_family_projection_used": False,
            "source_owner": "same upper 3-note closed-stack source logic as spread_2plus3_contract",
            "shell_plus_one_allowed": False,
            "selection": "groupwise_nearest_plus_whole_voicing_scorer",
            "overlap_with_lower_notes_allowed": False,
        },
...
def _render(score: dict[str, Any], *, expanded: bool, output: Path, audit_output: Path) -> dict[str, Any]:
    ...
    audit = _spread_3plus3_audit(debug, expanded_demo=expanded)
