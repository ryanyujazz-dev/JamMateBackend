...
OUTPUT = DEMOS_DIR / "v2_2_56_misty_jazz_ballad_spread_1plus3_expanded_color_demo.mid"
AUDIT_OUTPUT = DEMOS_DIR / "v2_2_56_misty_jazz_ballad_spread_1plus3_expanded_color_audit_summary.json"
...
def _first_listening_voicing_override() -> dict[str, Any]:
    ...
    return {
        ...
        "metadata": {
            ...
            "spread_1plus3_expanded_color_listening_only": True,
            "spread_selector_enabled": True,
            "ballad_spread_runtime_pilot": {
                "version": "v2_2_56_expanded_color",
                "enabled": True,
...
def _spread_1plus3_audit(debug: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "audit_version": "v2_2_56_expanded_color",
        "scope": "Ballad SPREAD 1+3 expanded-color listening audit; lower root + upper 3-note shell+color source when harmonic expansion is explicitly enabled.",
        "events": len(events),
