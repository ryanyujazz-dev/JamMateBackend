...
MILESTONE_ID = "v2_6_87"
MILESTONE_LABEL = "v2_6_87 — Medium Swing Full-Band Ending Realization Checkpoint"
...
def main() -> None:
    ...
    summary = {
        ...
        "scope": (
            "Medium Swing full-band ending realization checkpoint after the user-approved "
            "repeat-count-aware arrangement arc.  It audits piano ending subset stability, bass continuity, "
            "drum/piano density, explicit 5/6-note low-intrusion, low-register clarity, and dry swing behavior "
            "on 3x and 5x full-band demos.  It includes a generic terminal-ending anticipation guard so the "
            "final downbeat is not anticipated away; otherwise it does not add ending patterns, change multipliers, "
        ...
        "recommended_next_task": "v2_6_88_engine_medium_swing_style_baseline_phase_completion_checkpoint",
    }
    summary_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_full_band_ending_realization_checkpoint_summary.json"
    report_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_full_band_ending_realization_checkpoint_report.md"
    ...
    return {
        ...
        "metadata": {
            "medium_swing_existing_voicing_capability_usage_policy": {
                ...
                "available": True,
                "enabled": True,
                "activation": "explicit_v2_6_87_full_band_ending_realization_checkpoint_demo",
                ...
                "full_band_ending_realization_checkpoint_version": MILESTONE_ID,
                "arrangement_arc_runtime_intent_usage_scope": "full_band_ending_realization_checkpoint",
...
def _generate_and_audit(spec: Mapping[str, Any]) -> dict[str, Any]:
    ...
    midi_path = DEMOS_DIR / f"{MILESTONE_ID}_{slug}_{choruses}x_medium_swing_full_band_ending_realization_checkpoint_demo.mid"
    ...
    ending_checkpoint_rows = [row for row in piano_pattern_rows if row.get("ending_checkpoint_version") == MILESTONE_ID]
...
def _acceptance(static: Mapping[str, Any], outputs: list[Mapping[str, Any]], aggregate: Mapping[str, Any]) -> dict[str, Any]:
    checks = [
        {"name": "v2_6_87 ending realization checkpoint declared", "passed": static.get("ending_realization_checkpoint_version") == MILESTONE_ID and bool(static.get("ending_realization_checkpoint_enabled"))},
