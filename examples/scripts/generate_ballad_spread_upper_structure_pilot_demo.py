...
REFERENCE_OUTPUT = DEMOS_DIR / "v2_2_83_misty_jazz_ballad_spread_upper_structure_no_us_reference_demo.mid"
REFERENCE_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_83_misty_jazz_ballad_spread_upper_structure_no_us_reference_audit_summary.json"
EXPANDED_OUTPUT = DEMOS_DIR / "v2_2_83_misty_jazz_ballad_spread_upper_structure_pilot_demo.mid"
EXPANDED_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_83_misty_jazz_ballad_spread_upper_structure_pilot_audit_summary.json"

_VERSION = "v2_2_83"


def _mix_voicing_override(*, expanded: bool, upper_structure: bool = False) -> dict[str, Any]:
    metadata: dict[str, Any] = {
        ...
        "spread_top_voice_continuity_version": "v2_2_83",
        ...
        metadata.update(
            {
                ...
                "spread_upper_structure_prefer": False,
                "spread_upper_structure_only": False,
                "spread_upper_structure_pilot_version": _VERSION,
...
def _mix_audit(debug: dict[str, Any], *, expanded_demo: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "scope": "Ballad SPREAD upper-structure source-family pilot; default runtime remains unchanged.",
        "expanded_demo": bool(expanded_demo),
        "upper_structure_pilot": bool(expanded_demo),
        "events": len(events),
        ...
        "texture_state_mix_version": "v2_2_83",
        ...
        "top_voice_continuity_version": "v2_2_83",
...
def _run_one(*, expanded: bool, output: Path, audit_output: Path, upper_structure: bool = False) -> dict[str, Any]:
    ...
    result = generate_accompaniment(
        {
            ...
            "voicing_override": _mix_voicing_override(expanded=expanded, upper_structure=upper_structure),
        }
    )
    debug = dict(result.debug)
    audit = _mix_audit(debug, expanded_demo=upper_structure)
...
def main() -> None:
    ...
    reference = _run_one(expanded=True, output=REFERENCE_OUTPUT, audit_output=REFERENCE_AUDIT_OUTPUT, upper_structure=False)
    upper_structure = _run_one(expanded=True, output=EXPANDED_OUTPUT, audit_output=EXPANDED_AUDIT_OUTPUT, upper_structure=True)
    print(json.dumps({"no_us_reference": reference, "upper_structure_pilot": upper_structure}, indent=2, ensure_ascii=False))
