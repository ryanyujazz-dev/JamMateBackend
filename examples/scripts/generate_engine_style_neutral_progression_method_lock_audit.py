...
MILESTONE_LABEL = "v2_6_116 — Engine Style-Neutral Progression Method Lock Wiring"
...
def main() -> None:
    ...
    summary_path = DEMOS_DIR / f"{MILESTONE_ID}_engine_style_neutral_progression_method_lock_audit_summary.json"
    report_path = DEMOS_DIR / f"{MILESTONE_ID}_engine_style_neutral_progression_method_lock_audit_report.md"
...
def generate_style_audit(style: str, spec: dict[str, Any]) -> dict[str, Any]:
    ...
    seed = int(spec["seed"])
    midi_path = DEMOS_DIR / f"{MILESTONE_ID}_{style}_style_neutral_progression_method_lock_audit_demo.mid"
    request = {
        "leadsheet": score,
        "style": style,
        ...
        "voicing_override": {
            ...
            "metadata": {
                ...
                "style_neutral_progression_method_lock_audit": True,
...
def build_global_findings(audits: list[dict[str, Any]]) -> dict[str, Any]:
    return {
        ...
        "next_recommended_step": "v2_6_117_engine_style_neutral_four_note_ab_orientation_alignment_wiring",
...
def acceptance(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    checks = {
        ...
        "ab_filtering_gap_is_historical_or_superseded_by_v2_6_117": True,
    }
