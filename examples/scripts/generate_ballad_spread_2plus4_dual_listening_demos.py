...
UNEXPANDED_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_2plus4_root_anchor_e2_e3_gap_p5_unexpanded_demo.mid"
UNEXPANDED_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_2plus4_root_anchor_e2_e3_gap_p5_unexpanded_audit_summary.json"
EXPANDED_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_2plus4_root_anchor_e2_e3_gap_p5_expanded_60pct_demo.mid"
EXPANDED_AUDIT_OUTPUT = DEMOS_DIR / "v2_2_73_misty_jazz_ballad_spread_2plus4_root_anchor_e2_e3_gap_p5_expanded_60pct_audit_summary.json"


_CONTRACT_ID = "spread_2plus4_contract"
_VERSION = "v2_2_73"
...
def _listening_voicing_override(*, expanded: bool) -> dict[str, Any]:
    metadata: dict[str, Any] = {
        ...
        "ballad_spread_2plus4_pilot": {
            "version": _VERSION,
            "enabled": True,
            "required_recipe_id": _CONTRACT_ID,
            "dual_demo_required": True,
            "expanded_demo_target_ratio": 0.60,
            "target": "explicit_ballad_spread_2plus4_listening_isolation_only",
...
def _spread_2plus4_audit(debug: dict[str, Any], *, expanded_demo: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "scope": "Ballad SPREAD 2+4 dual-demo audit; 2-note rooted bass anchor from 2+3 plus upper 4-note DROP2/DROP3 logic from 1+4; expanded demo targets ~60% actual color.",
        ...
        "upper_4note_policy": {
            ...
            "source_owner": "same upper 4-note source/projection logic as spread_1plus4_contract",
...
def _render(score: dict[str, Any], *, expanded: bool, output: Path, audit_output: Path) -> dict[str, Any]:
    ...
    audit = _spread_2plus4_audit(debug, expanded_demo=expanded)
