...
MILESTONE_ID = "v2_6_85"
MILESTONE_LABEL = "v2_6_85 — Medium Swing Arrangement Arc Runtime Intent Usage"
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_task": "v2_6_86_engine_medium_swing_arrangement_arc_runtime_intent_listening_refinement_if_needed",
    }
    summary_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_arrangement_arc_runtime_intent_usage_summary.json"
    report_path = DEMOS_DIR / f"{MILESTONE_ID}_medium_swing_arrangement_arc_runtime_intent_usage_report.md"
    ...
    return {
        ...
        "metadata": {
            "medium_swing_existing_voicing_capability_usage_policy": {
                ...
                "arrangement_arc_runtime_intent_usage_version": MILESTONE_ID,
                "arrangement_arc_runtime_intent_usage_scope": "runtime_intent_usage_checkpoint",
...
def _generate_and_audit(spec: Mapping[str, Any]) -> dict[str, Any]:
    ...
    midi_path = DEMOS_DIR / f"{MILESTONE_ID}_{slug}_{choruses}x_medium_swing_arrangement_arc_runtime_intent_usage_demo.mid"
    ...
    arc_runtime_rows = [row for row in piano_pattern_rows if row.get("arrangement_arc_runtime_intent_usage_version") == MILESTONE_ID]
...
def _per_chorus_metrics(pattern_rows: list[Mapping[str, Any]], voicing_rows: list[Mapping[str, Any]], total: int) -> list[dict[str, Any]]:
    ...
    for item in arc:
        ...
        arc_rows = [row for row in pattern if row.get("arrangement_arc_runtime_intent_usage_version") == MILESTONE_ID]
        out.append(
            {
                **item,
...
def _acceptance(static: Mapping[str, Any], outputs: list[Mapping[str, Any]], aggregate: Mapping[str, Any]) -> dict[str, Any]:
    checks = [
        ...
        {"name": "v2_6_85 runtime intent usage declared", "passed": static.get("arrangement_arc_runtime_intent_usage_version") == MILESTONE_ID and bool(static.get("arrangement_arc_runtime_intent_usage_enabled"))},
