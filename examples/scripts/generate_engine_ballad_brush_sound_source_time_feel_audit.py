...
MILESTONE_ID = "v2_6_132"
MILESTONE_LABEL = "v2_6_132 — Engine Ballad Brush Source Shared Swing-8 Timing Contract"
...
def main() -> None:
    ...
    summary = {
        ...
        "scope": (
            "Reset Jazz Ballad drums around a real brush sound source: bar-level brush time feel, continuous eighth sweep path, "
            "contextual 1&/2&/3&/4& offbeat policy, soft 2/4 foot anchors, felt-not-heard feather kick, phrase breath, and final release. "
            "No custom internal brush drum voices, no chord-region dense drum loop, and no piano/bass/voicing/API/Agent/HarmonyOS change."
        ),
        "static_audit": static,
        "runtime_audit": runtime,
        "acceptance": acceptance,
        "recommended_next_task": "v2_6_133_engine_ballad_brush_sound_source_listening_calibration",
    }
    summary_path = DEMOS_DIR / f"{MILESTONE_ID}_engine_ballad_brush_sound_source_time_feel_summary.json"
    report_path = DEMOS_DIR / f"{MILESTONE_ID}_engine_ballad_brush_sound_source_time_feel_report.md"
...
def _generate_misty_runtime_audit() -> dict[str, Any]:
    ...
    midi_path = DEMOS_DIR / f"{MILESTONE_ID}_misty_jazz_ballad_brush_sound_source_time_feel_demo.mid"
