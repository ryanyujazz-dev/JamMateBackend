...
def test_v2_6_136_policy_declares_section_transition_hint_contract() -> None:
...
def test_v2_6_136_section_tail_uses_short_4and_hint_not_explicit_fill_display() -> None:
...
def test_v2_6_136_section_entry_uses_one_soft_bloom_on_beat_1() -> None:
    candidate = _candidate({
        "region_duration_beats": 4.0,
...
def test_v2_6_136_cadence_hint_is_two_event_3and_to_4_not_long_tap_drag() -> None:
    candidate = _candidate({
        "region_duration_beats": 4.0,
...
def test_v2_6_136_stronger_fill_cells_remain_vocabulary_but_not_default_selection() -> None:
    contexts = [
    ...
    assert {"section_tail_4_hat_cymbal_hint", "bridge_entry_low_tom_bloom_hint", "v1_drag_to_4_hint", "turnaround_2and_4_hat_hint", "turnaround_cross_stick_4_hint"} & selected
